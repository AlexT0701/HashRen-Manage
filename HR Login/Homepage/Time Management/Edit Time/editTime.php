  ...
  <fieldset>
    ...
    <form name="addEmployee" method="post">
      <p>
        ...
        <input type="text" name="txtName" id="txtId" placeholder="Employee Name" >
      </p>
      <p>
...
<?php
   if (isset($_POST['Submit']))
   {
      ...
      if ($exists == "True")
      {
        ...
        //$sql = "INSERT INTO `tbl_availability` (`User`, `Sun`, `Mon`, `Tues`, `Wed`, `Thur`, `Fri`, `Sat`) VALUES ('$txtName', '$txtSun', '$txtMon', '$txtTues', '$txtWed', '$txtThurs', '$txtFri', '$txtSat')";
        ...
        if ($txtSun != "")
        {
          $q = "UPDATE tbl_availability SET Sun ='$txtSun' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
		
        if ($txtMon != "")
        {
          $q = "UPDATE tbl_availability SET Mon ='$txtMon' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
		
        if ($txtTues != "")
        {
          $q = "UPDATE tbl_availability SET Tues ='$txtTues' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
		
        if ($txtWed != "")
        {
          $q = "UPDATE tbl_availability SET Wed ='$txtWed' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
		
        if ($txtThurs != "")
        {
          $q = "UPDATE tbl_availability SET Thur ='$txtThurs' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
		
        if ($txtFri != "")
        {
          $q = "UPDATE tbl_availability SET Fri ='$txtFri' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
		
        if ($txtSat != "")
        {
          $q = "UPDATE tbl_availability SET Sat ='$txtSat' WHERE User='$txtName'";
          $r = mysqli_query($con, $q);
        }
